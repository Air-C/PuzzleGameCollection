...
namespace Controller
{
    public class GridManager
    {
        ...
        public Square[,] grid = new Square[10, 18];
        ...
        public SquareMoveStatus IsEnableMove(List<Square> squares, MoveDirection moveDirection)
        {
        ...
        public SquareMoveStatus IsEnableRotate(List<Square> squares, RotateDirection direction)
        {
            foreach (Square square in squares)
            {
                Vector2Int newGridIndex = square.GridIndex;
        ...
        public void SaveSquare(List<Square> squares)
        {
